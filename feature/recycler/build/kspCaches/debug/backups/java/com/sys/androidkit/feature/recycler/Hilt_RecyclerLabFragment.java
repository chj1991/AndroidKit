...
public abstract class Hilt_RecyclerLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecyclerLabFragment_GeneratedInjector) this.generatedComponent()).injectRecyclerLabFragment(UnsafeCasts.<RecyclerLabFragment>unsafeCast(this));
    }
  }
