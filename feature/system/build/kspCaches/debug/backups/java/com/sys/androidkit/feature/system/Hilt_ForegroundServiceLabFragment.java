...
public abstract class Hilt_ForegroundServiceLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ForegroundServiceLabFragment_GeneratedInjector) this.generatedComponent()).injectForegroundServiceLabFragment(UnsafeCasts.<ForegroundServiceLabFragment>unsafeCast(this));
    }
  }
