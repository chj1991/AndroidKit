...
public abstract class Hilt_NotificationLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NotificationLabFragment_GeneratedInjector) this.generatedComponent()).injectNotificationLabFragment(UnsafeCasts.<NotificationLabFragment>unsafeCast(this));
    }
  }
