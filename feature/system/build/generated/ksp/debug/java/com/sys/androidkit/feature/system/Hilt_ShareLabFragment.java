...
public abstract class Hilt_ShareLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ShareLabFragment_GeneratedInjector) this.generatedComponent()).injectShareLabFragment(UnsafeCasts.<ShareLabFragment>unsafeCast(this));
    }
  }
