...
public abstract class Hilt_PermissionLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PermissionLabFragment_GeneratedInjector) this.generatedComponent()).injectPermissionLabFragment(UnsafeCasts.<PermissionLabFragment>unsafeCast(this));
    }
  }
