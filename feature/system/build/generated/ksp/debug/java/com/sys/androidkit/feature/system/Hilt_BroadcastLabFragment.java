...
public abstract class Hilt_BroadcastLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BroadcastLabFragment_GeneratedInjector) this.generatedComponent()).injectBroadcastLabFragment(UnsafeCasts.<BroadcastLabFragment>unsafeCast(this));
    }
  }
