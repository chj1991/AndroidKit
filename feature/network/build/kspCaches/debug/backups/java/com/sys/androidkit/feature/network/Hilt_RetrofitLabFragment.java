...
public abstract class Hilt_RetrofitLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RetrofitLabFragment_GeneratedInjector) this.generatedComponent()).injectRetrofitLabFragment(UnsafeCasts.<RetrofitLabFragment>unsafeCast(this));
    }
  }
