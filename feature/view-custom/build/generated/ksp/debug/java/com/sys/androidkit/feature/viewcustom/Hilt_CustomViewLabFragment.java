...
public abstract class Hilt_CustomViewLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomViewLabFragment_GeneratedInjector) this.generatedComponent()).injectCustomViewLabFragment(UnsafeCasts.<CustomViewLabFragment>unsafeCast(this));
    }
  }
