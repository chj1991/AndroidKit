...
public abstract class Hilt_NestedScrollLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((NestedScrollLabFragment_GeneratedInjector) this.generatedComponent()).injectNestedScrollLabFragment(UnsafeCasts.<NestedScrollLabFragment>unsafeCast(this));
    }
  }
