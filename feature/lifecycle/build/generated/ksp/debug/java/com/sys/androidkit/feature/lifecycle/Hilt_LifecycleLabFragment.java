...
public abstract class Hilt_LifecycleLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LifecycleLabFragment_GeneratedInjector) this.generatedComponent()).injectLifecycleLabFragment(UnsafeCasts.<LifecycleLabFragment>unsafeCast(this));
    }
  }
