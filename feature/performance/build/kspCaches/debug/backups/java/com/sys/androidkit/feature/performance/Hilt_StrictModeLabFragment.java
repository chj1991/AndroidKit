...
public abstract class Hilt_StrictModeLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StrictModeLabFragment_GeneratedInjector) this.generatedComponent()).injectStrictModeLabFragment(UnsafeCasts.<StrictModeLabFragment>unsafeCast(this));
    }
  }
