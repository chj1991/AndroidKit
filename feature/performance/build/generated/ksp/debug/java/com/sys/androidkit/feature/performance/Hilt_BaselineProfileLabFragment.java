...
public abstract class Hilt_BaselineProfileLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BaselineProfileLabFragment_GeneratedInjector) this.generatedComponent()).injectBaselineProfileLabFragment(UnsafeCasts.<BaselineProfileLabFragment>unsafeCast(this));
    }
  }
