...
public abstract class Hilt_LeakLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LeakLabFragment_GeneratedInjector) this.generatedComponent()).injectLeakLabFragment(UnsafeCasts.<LeakLabFragment>unsafeCast(this));
    }
  }
