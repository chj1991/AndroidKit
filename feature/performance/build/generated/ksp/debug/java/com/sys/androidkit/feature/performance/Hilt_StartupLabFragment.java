...
public abstract class Hilt_StartupLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StartupLabFragment_GeneratedInjector) this.generatedComponent()).injectStartupLabFragment(UnsafeCasts.<StartupLabFragment>unsafeCast(this));
    }
  }
