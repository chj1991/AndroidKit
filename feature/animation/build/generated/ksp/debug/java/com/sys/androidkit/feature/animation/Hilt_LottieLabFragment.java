...
public abstract class Hilt_LottieLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((LottieLabFragment_GeneratedInjector) this.generatedComponent()).injectLottieLabFragment(UnsafeCasts.<LottieLabFragment>unsafeCast(this));
    }
  }
