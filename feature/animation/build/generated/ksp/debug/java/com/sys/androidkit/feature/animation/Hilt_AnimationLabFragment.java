...
public abstract class Hilt_AnimationLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((AnimationLabFragment_GeneratedInjector) this.generatedComponent()).injectAnimationLabFragment(UnsafeCasts.<AnimationLabFragment>unsafeCast(this));
    }
  }
