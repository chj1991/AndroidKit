...
public abstract class Hilt_TransitionLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((TransitionLabFragment_GeneratedInjector) this.generatedComponent()).injectTransitionLabFragment(UnsafeCasts.<TransitionLabFragment>unsafeCast(this));
    }
  }
