...
public abstract class Hilt_MotionLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((MotionLabFragment_GeneratedInjector) this.generatedComponent()).injectMotionLabFragment(UnsafeCasts.<MotionLabFragment>unsafeCast(this));
    }
  }
