...
public abstract class Hilt_CompatLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CompatLabFragment_GeneratedInjector) this.generatedComponent()).injectCompatLabFragment(UnsafeCasts.<CompatLabFragment>unsafeCast(this));
    }
  }
