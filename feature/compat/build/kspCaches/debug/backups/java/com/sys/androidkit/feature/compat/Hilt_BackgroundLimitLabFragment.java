...
public abstract class Hilt_BackgroundLimitLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((BackgroundLimitLabFragment_GeneratedInjector) this.generatedComponent()).injectBackgroundLimitLabFragment(UnsafeCasts.<BackgroundLimitLabFragment>unsafeCast(this));
    }
  }
