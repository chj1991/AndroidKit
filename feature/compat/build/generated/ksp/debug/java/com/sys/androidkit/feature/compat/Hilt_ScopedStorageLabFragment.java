...
public abstract class Hilt_ScopedStorageLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ScopedStorageLabFragment_GeneratedInjector) this.generatedComponent()).injectScopedStorageLabFragment(UnsafeCasts.<ScopedStorageLabFragment>unsafeCast(this));
    }
  }
