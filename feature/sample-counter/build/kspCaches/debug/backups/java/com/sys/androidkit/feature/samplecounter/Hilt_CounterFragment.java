...
public abstract class Hilt_CounterFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CounterFragment_GeneratedInjector) this.generatedComponent()).injectCounterFragment(UnsafeCasts.<CounterFragment>unsafeCast(this));
    }
  }
