...
public abstract class Hilt_CoroutineLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CoroutineLabFragment_GeneratedInjector) this.generatedComponent()).injectCoroutineLabFragment(UnsafeCasts.<CoroutineLabFragment>unsafeCast(this));
    }
  }
