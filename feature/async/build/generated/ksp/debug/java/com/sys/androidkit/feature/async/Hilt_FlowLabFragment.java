...
public abstract class Hilt_FlowLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((FlowLabFragment_GeneratedInjector) this.generatedComponent()).injectFlowLabFragment(UnsafeCasts.<FlowLabFragment>unsafeCast(this));
    }
  }
