...
public abstract class Hilt_StructuredConcurrencyLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((StructuredConcurrencyLabFragment_GeneratedInjector) this.generatedComponent()).injectStructuredConcurrencyLabFragment(UnsafeCasts.<StructuredConcurrencyLabFragment>unsafeCast(this));
    }
  }
