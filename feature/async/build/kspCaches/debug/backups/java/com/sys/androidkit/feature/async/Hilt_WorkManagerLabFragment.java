...
public abstract class Hilt_WorkManagerLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((WorkManagerLabFragment_GeneratedInjector) this.generatedComponent()).injectWorkManagerLabFragment(UnsafeCasts.<WorkManagerLabFragment>unsafeCast(this));
    }
  }
