...
public abstract class Hilt_CameraXLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CameraXLabFragment_GeneratedInjector) this.generatedComponent()).injectCameraXLabFragment(UnsafeCasts.<CameraXLabFragment>unsafeCast(this));
    }
  }
