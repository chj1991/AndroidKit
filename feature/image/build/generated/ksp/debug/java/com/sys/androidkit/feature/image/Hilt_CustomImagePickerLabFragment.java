...
public abstract class Hilt_CustomImagePickerLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomImagePickerLabFragment_GeneratedInjector) this.generatedComponent()).injectCustomImagePickerLabFragment(UnsafeCasts.<CustomImagePickerLabFragment>unsafeCast(this));
    }
  }
