...
public abstract class Hilt_PhotoPickerLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((PhotoPickerLabFragment_GeneratedInjector) this.generatedComponent()).injectPhotoPickerLabFragment(UnsafeCasts.<PhotoPickerLabFragment>unsafeCast(this));
    }
  }
