...
public abstract class Hilt_CustomImagePickerSelectFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((CustomImagePickerSelectFragment_GeneratedInjector) this.generatedComponent()).injectCustomImagePickerSelectFragment(UnsafeCasts.<CustomImagePickerSelectFragment>unsafeCast(this));
    }
  }
