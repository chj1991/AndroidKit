...
public abstract class Hilt_ImageLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((ImageLabFragment_GeneratedInjector) this.generatedComponent()).injectImageLabFragment(UnsafeCasts.<ImageLabFragment>unsafeCast(this));
    }
  }
