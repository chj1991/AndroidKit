...
public abstract class Hilt_DataStoreLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((DataStoreLabFragment_GeneratedInjector) this.generatedComponent()).injectDataStoreLabFragment(UnsafeCasts.<DataStoreLabFragment>unsafeCast(this));
    }
  }
