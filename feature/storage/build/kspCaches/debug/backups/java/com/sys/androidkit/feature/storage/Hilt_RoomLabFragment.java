...
public abstract class Hilt_RoomLabFragment<VB extends ViewBinding> extends BaseFragment<VB> implements GeneratedComponentManagerHolder {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RoomLabFragment_GeneratedInjector) this.generatedComponent()).injectRoomLabFragment(UnsafeCasts.<RoomLabFragment>unsafeCast(this));
    }
  }
